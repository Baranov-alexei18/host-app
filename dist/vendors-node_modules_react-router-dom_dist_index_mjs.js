 ...
 */
(self["webpackChunkhost_app_module_federation"] = self["webpackChunkhost_app_module_federation"] || []).push([["vendors-node_modules_react-router-dom_dist_index_mjs"],{
...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   HydratedRouter: () => (/* binding */ HydratedRouter),\n/* harmony export */   RouterProvider: () => (/* binding */ RouterProvider2)\n/* harmony export */ });\n/* harmony import */ var _chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunk-KIUJAIYX.mjs */ \"./node_modules/react-router/dist/development/chunk-KIUJAIYX.mjs\");\n/* harmony import */ var _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-C37GKA54.mjs */ \"./node_modules/react-router/dist/development/chunk-C37GKA54.mjs\");\n/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react */ \"webpack/sharing/consume/default/react/react?ea65\");\n/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! react-dom */ \"webpack/sharing/consume/default/react-dom/react-dom?b5ff\");\n/**\n * react-router v7.7.1\n *\n * Copyright (c) Remix Software Inc.\n *\n * This source code is licensed under the MIT license found in the\n * LICENSE.md file in the root directory of this source tree.\n *\n * @license MIT\n */\n\"use client\";\n\n\n\n// lib/dom-export/dom-router-provider.tsx\n\n\nfunction RouterProvider2(props) {\n  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_2__.createElement(_chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.RouterProvider, { flushSync: react_dom__WEBPACK_IMPORTED_MODULE_3__.flushSync, ...props });\n}\n\n// lib/dom-export/hydrated-router.tsx\n\nvar ssrInfo = null;\nvar router = null;\nfunction initSsrInfo() {\n  if (!ssrInfo && window.__reactRouterContext && window.__reactRouterManifest && window.__reactRouterRouteModules) {\n    if (window.__reactRouterManifest.sri === true) {\n      const importMap = document.querySelector(\"script[rr-importmap]\");\n      if (importMap?.textContent) {\n        try {\n          window.__reactRouterManifest.sri = JSON.parse(\n            importMap.textContent\n          ).integrity;\n        } catch (err) {\n          console.error(\"Failed to parse import map\", err);\n        }\n      }\n    }\n    ssrInfo = {\n      context: window.__reactRouterContext,\n      manifest: window.__reactRouterManifest,\n      routeModules: window.__reactRouterRouteModules,\n      stateDecodingPromise: void 0,\n      router: void 0,\n      routerInitialized: false\n    };\n  }\n}\nfunction createHydratedRouter({\n  unstable_getContext\n}) {\n  initSsrInfo();\n  if (!ssrInfo) {\n    throw new Error(\n      \"You must be using the SSR features of React Router in order to skip passing a `router` prop to `<RouterProvider>`\"\n    );\n  }\n  let localSsrInfo = ssrInfo;\n  if (!ssrInfo.stateDecodingPromise) {\n    let stream = ssrInfo.context.stream;\n    (0,_chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.invariant)(stream, \"No stream found for single fetch decoding\");\n    ssrInfo.context.stream = void 0;\n    ssrInfo.stateDecodingPromise = (0,_chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.decodeViaTurboStream)(stream, window).then((value) => {\n      ssrInfo.context.state = value.value;\n      localSsrInfo.stateDecodingPromise.value = true;\n    }).catch((e) => {\n      localSsrInfo.stateDecodingPromise.error = e;\n    });\n  }\n  if (ssrInfo.stateDecodingPromise.error) {\n    throw ssrInfo.stateDecodingPromise.error;\n  }\n  if (!ssrInfo.stateDecodingPromise.value) {\n    throw ssrInfo.stateDecodingPromise;\n  }\n  let routes = (0,_chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.createClientRoutes)(\n    ssrInfo.manifest.routes,\n    ssrInfo.routeModules,\n    ssrInfo.context.state,\n    ssrInfo.context.ssr,\n    ssrInfo.context.isSpaMode\n  );\n  let hydrationData = void 0;\n  if (ssrInfo.context.isSpaMode) {\n    let { loaderData } = ssrInfo.context.state;\n    if (ssrInfo.manifest.routes.root?.hasLoader && loaderData && \"root\" in loaderData) {\n      hydrationData = {\n        loaderData: {\n          root: loaderData.root\n        }\n      };\n    }\n  } else {\n    hydrationData = (0,_chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__.getHydrationData)(\n      ssrInfo.context.state,\n      routes,\n      (routeId) => ({\n        clientLoader: ssrInfo.routeModules[routeId]?.clientLoader,\n        hasLoader: ssrInfo.manifest.routes[routeId]?.hasLoader === true,\n        hasHydrateFallback: ssrInfo.routeModules[routeId]?.HydrateFallback != null\n      }),\n      window.location,\n      window.__reactRouterContext?.basename,\n      ssrInfo.context.isSpaMode\n    );\n    if (hydrationData && hydrationData.errors) {\n      hydrationData.errors = (0,_chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__.deserializeErrors)(hydrationData.errors);\n    }\n  }\n  let router2 = (0,_chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.createRouter)({\n    routes,\n    history: (0,_chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.createBrowserHistory)(),\n    basename: ssrInfo.context.basename,\n    unstable_getContext,\n    hydrationData,\n    hydrationRouteProperties: _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.hydrationRouteProperties,\n    mapRouteProperties: _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.mapRouteProperties,\n    future: {\n      unstable_middleware: ssrInfo.context.future.unstable_middleware\n    },\n    dataStrategy: (0,_chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.getTurboStreamSingleFetchDataStrategy)(\n      () => router2,\n      ssrInfo.manifest,\n      ssrInfo.routeModules,\n      ssrInfo.context.ssr,\n      ssrInfo.context.basename\n    ),\n    patchRoutesOnNavigation: (0,_chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.getPatchRoutesOnNavigationFunction)(\n      ssrInfo.manifest,\n      ssrInfo.routeModules,\n      ssrInfo.context.ssr,\n      ssrInfo.context.routeDiscovery,\n      ssrInfo.context.isSpaMode,\n      ssrInfo.context.basename\n    )\n  });\n  ssrInfo.router = router2;\n  if (router2.state.initialized) {\n    ssrInfo.routerInitialized = true;\n    router2.initialize();\n  }\n  router2.createRoutesForHMR = /* spacer so ts-ignore does not affect the right hand of the assignment */\n  _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.createClientRoutesWithHMRRevalidationOptOut;\n  window.__reactRouterDataRouter = router2;\n  return router2;\n}\nfunction HydratedRouter(props) {\n  if (!router) {\n    router = createHydratedRouter({\n      unstable_getContext: props.unstable_getContext\n    });\n  }\n  let [criticalCss, setCriticalCss] = react__WEBPACK_IMPORTED_MODULE_2__.useState(\n     true ? ssrInfo?.context.criticalCss : 0\n  );\n  react__WEBPACK_IMPORTED_MODULE_2__.useEffect(() => {\n    if (true) {\n      setCriticalCss(void 0);\n    }\n  }, []);\n  react__WEBPACK_IMPORTED_MODULE_2__.useEffect(() => {\n    if ( true && criticalCss === void 0) {\n      document.querySelectorAll(`[${_chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.CRITICAL_CSS_DATA_ATTRIBUTE}]`).forEach((element) => element.remove());\n    }\n  }, [criticalCss]);\n  let [location, setLocation] = react__WEBPACK_IMPORTED_MODULE_2__.useState(router.state.location);\n  react__WEBPACK_IMPORTED_MODULE_2__.useLayoutEffect(() => {\n    if (ssrInfo && ssrInfo.router && !ssrInfo.routerInitialized) {\n      ssrInfo.routerInitialized = true;\n      ssrInfo.router.initialize();\n    }\n  }, []);\n  react__WEBPACK_IMPORTED_MODULE_2__.useLayoutEffect(() => {\n    if (ssrInfo && ssrInfo.router) {\n      return ssrInfo.router.subscribe((newState) => {\n        if (newState.location !== location) {\n          setLocation(newState.location);\n        }\n      });\n    }\n  }, [location]);\n  (0,_chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.invariant)(ssrInfo, \"ssrInfo unavailable for HydratedRouter\");\n  (0,_chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useFogOFWarDiscovery)(\n    router,\n    ssrInfo.manifest,\n    ssrInfo.routeModules,\n    ssrInfo.context.ssr,\n    ssrInfo.context.routeDiscovery,\n    ssrInfo.context.isSpaMode\n  );\n  return (\n    // This fragment is important to ensure we match the <ServerRouter> JSX\n    // structure so that useId values hydrate correctly\n    /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_2__.createElement(react__WEBPACK_IMPORTED_MODULE_2__.Fragment, null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_2__.createElement(\n      _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.FrameworkContext.Provider,\n      {\n        value: {\n          manifest: ssrInfo.manifest,\n          routeModules: ssrInfo.routeModules,\n          future: ssrInfo.context.future,\n          criticalCss,\n          ssr: ssrInfo.context.ssr,\n          isSpaMode: ssrInfo.context.isSpaMode,\n          routeDiscovery: ssrInfo.context.routeDiscovery\n        }\n      },\n      /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_2__.createElement(_chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.RemixErrorBoundary, { location }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_2__.createElement(RouterProvider2, { router }))\n    ), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_2__.createElement(react__WEBPACK_IMPORTED_MODULE_2__.Fragment, null))\n  );\n}\n\n\n\n//# sourceURL=webpack://host-app-module-federation/./node_modules/react-router/dist/development/dom-export.mjs?\n}");
...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   Await: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.Await),\n/* harmony export */   BrowserRouter: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.BrowserRouter),\n/* harmony export */   Form: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.Form),\n/* harmony export */   HashRouter: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.HashRouter),\n/* harmony export */   IDLE_BLOCKER: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.IDLE_BLOCKER),\n/* harmony export */   IDLE_FETCHER: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.IDLE_FETCHER),\n/* harmony export */   IDLE_NAVIGATION: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.IDLE_NAVIGATION),\n/* harmony export */   Link: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.Link),\n/* harmony export */   Links: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.Links),\n/* harmony export */   MemoryRouter: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.MemoryRouter),\n/* harmony export */   Meta: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.Meta),\n/* harmony export */   NavLink: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.NavLink),\n/* harmony export */   Navigate: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.Navigate),\n/* harmony export */   NavigationType: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.Action),\n/* harmony export */   Outlet: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.Outlet),\n/* harmony export */   PrefetchPageLinks: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.PrefetchPageLinks),\n/* harmony export */   Route: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.Route),\n/* harmony export */   Router: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.Router),\n/* harmony export */   RouterProvider: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.RouterProvider),\n/* harmony export */   Routes: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.Routes),\n/* harmony export */   Scripts: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.Scripts),\n/* harmony export */   ScrollRestoration: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.ScrollRestoration),\n/* harmony export */   ServerRouter: () => (/* reexport safe */ _chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__.ServerRouter),\n/* harmony export */   StaticRouter: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.StaticRouter),\n/* harmony export */   StaticRouterProvider: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.StaticRouterProvider),\n/* harmony export */   UNSAFE_DataRouterContext: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.DataRouterContext),\n/* harmony export */   UNSAFE_DataRouterStateContext: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.DataRouterStateContext),\n/* harmony export */   UNSAFE_ErrorResponseImpl: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.ErrorResponseImpl),\n/* harmony export */   UNSAFE_FetchersContext: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.FetchersContext),\n/* harmony export */   UNSAFE_FrameworkContext: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.FrameworkContext),\n/* harmony export */   UNSAFE_LocationContext: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.LocationContext),\n/* harmony export */   UNSAFE_NavigationContext: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.NavigationContext),\n/* harmony export */   UNSAFE_RSCDefaultRootErrorBoundary: () => (/* reexport safe */ _chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__.RSCDefaultRootErrorBoundary),\n/* harmony export */   UNSAFE_RemixErrorBoundary: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.RemixErrorBoundary),\n/* harmony export */   UNSAFE_RouteContext: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.RouteContext),\n/* harmony export */   UNSAFE_ServerMode: () => (/* reexport safe */ _chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__.ServerMode),\n/* harmony export */   UNSAFE_SingleFetchRedirectSymbol: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.SingleFetchRedirectSymbol),\n/* harmony export */   UNSAFE_ViewTransitionContext: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.ViewTransitionContext),\n/* harmony export */   UNSAFE_WithComponentProps: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.WithComponentProps),\n/* harmony export */   UNSAFE_WithErrorBoundaryProps: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.WithErrorBoundaryProps),\n/* harmony export */   UNSAFE_WithHydrateFallbackProps: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.WithHydrateFallbackProps),\n/* harmony export */   UNSAFE_createBrowserHistory: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.createBrowserHistory),\n/* harmony export */   UNSAFE_createClientRoutes: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.createClientRoutes),\n/* harmony export */   UNSAFE_createClientRoutesWithHMRRevalidationOptOut: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.createClientRoutesWithHMRRevalidationOptOut),\n/* harmony export */   UNSAFE_createRouter: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.createRouter),\n/* harmony export */   UNSAFE_decodeViaTurboStream: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.decodeViaTurboStream),\n/* harmony export */   UNSAFE_deserializeErrors: () => (/* reexport safe */ _chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__.deserializeErrors),\n/* harmony export */   UNSAFE_getHydrationData: () => (/* reexport safe */ _chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__.getHydrationData),\n/* harmony export */   UNSAFE_getPatchRoutesOnNavigationFunction: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.getPatchRoutesOnNavigationFunction),\n/* harmony export */   UNSAFE_getTurboStreamSingleFetchDataStrategy: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.getTurboStreamSingleFetchDataStrategy),\n/* harmony export */   UNSAFE_hydrationRouteProperties: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.hydrationRouteProperties),\n/* harmony export */   UNSAFE_invariant: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.invariant),\n/* harmony export */   UNSAFE_mapRouteProperties: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.mapRouteProperties),\n/* harmony export */   UNSAFE_shouldHydrateRouteLoader: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.shouldHydrateRouteLoader),\n/* harmony export */   UNSAFE_useFogOFWarDiscovery: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useFogOFWarDiscovery),\n/* harmony export */   UNSAFE_useScrollRestoration: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useScrollRestoration),\n/* harmony export */   UNSAFE_withComponentProps: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.withComponentProps),\n/* harmony export */   UNSAFE_withErrorBoundaryProps: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.withErrorBoundaryProps),\n/* harmony export */   UNSAFE_withHydrateFallbackProps: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.withHydrateFallbackProps),\n/* harmony export */   createBrowserRouter: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.createBrowserRouter),\n/* harmony export */   createCookie: () => (/* reexport safe */ _chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__.createCookie),\n/* harmony export */   createCookieSessionStorage: () => (/* reexport safe */ _chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__.createCookieSessionStorage),\n/* harmony export */   createHashRouter: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.createHashRouter),\n/* harmony export */   createMemoryRouter: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.createMemoryRouter),\n/* harmony export */   createMemorySessionStorage: () => (/* reexport safe */ _chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__.createMemorySessionStorage),\n/* harmony export */   createPath: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.createPath),\n/* harmony export */   createRequestHandler: () => (/* reexport safe */ _chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__.createRequestHandler),\n/* harmony export */   createRoutesFromChildren: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.createRoutesFromChildren),\n/* harmony export */   createRoutesFromElements: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.createRoutesFromElements),\n/* harmony export */   createRoutesStub: () => (/* reexport safe */ _chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__.createRoutesStub),\n/* harmony export */   createSearchParams: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.createSearchParams),\n/* harmony export */   createSession: () => (/* reexport safe */ _chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__.createSession),\n/* harmony export */   createSessionStorage: () => (/* reexport safe */ _chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__.createSessionStorage),\n/* harmony export */   createStaticHandler: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.createStaticHandler2),\n/* harmony export */   createStaticRouter: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.createStaticRouter),\n/* harmony export */   data: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.data),\n/* harmony export */   generatePath: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.generatePath),\n/* harmony export */   href: () => (/* reexport safe */ _chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__.href),\n/* harmony export */   isCookie: () => (/* reexport safe */ _chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__.isCookie),\n/* harmony export */   isRouteErrorResponse: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.isRouteErrorResponse),\n/* harmony export */   isSession: () => (/* reexport safe */ _chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__.isSession),\n/* harmony export */   matchPath: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.matchPath),\n/* harmony export */   matchRoutes: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.matchRoutes),\n/* harmony export */   parsePath: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.parsePath),\n/* harmony export */   redirect: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.redirect),\n/* harmony export */   redirectDocument: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.redirectDocument),\n/* harmony export */   renderMatches: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.renderMatches),\n/* harmony export */   replace: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.replace),\n/* harmony export */   resolvePath: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.resolvePath),\n/* harmony export */   unstable_HistoryRouter: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.HistoryRouter),\n/* harmony export */   unstable_RSCHydratedRouter: () => (/* reexport safe */ _chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__.RSCHydratedRouter),\n/* harmony export */   unstable_RSCStaticRouter: () => (/* reexport safe */ _chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__.RSCStaticRouter),\n/* harmony export */   unstable_RouterContextProvider: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.unstable_RouterContextProvider),\n/* harmony export */   unstable_createCallServer: () => (/* reexport safe */ _chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__.createCallServer),\n/* harmony export */   unstable_createContext: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.unstable_createContext),\n/* harmony export */   unstable_getRSCStream: () => (/* reexport safe */ _chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__.getRSCStream),\n/* harmony export */   unstable_routeRSCServerRequest: () => (/* reexport safe */ _chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__.routeRSCServerRequest),\n/* harmony export */   unstable_setDevServerHooks: () => (/* reexport safe */ _chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__.setDevServerHooks),\n/* harmony export */   unstable_usePrompt: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.usePrompt),\n/* harmony export */   useActionData: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useActionData),\n/* harmony export */   useAsyncError: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useAsyncError),\n/* harmony export */   useAsyncValue: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useAsyncValue),\n/* harmony export */   useBeforeUnload: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useBeforeUnload),\n/* harmony export */   useBlocker: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useBlocker),\n/* harmony export */   useFetcher: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useFetcher),\n/* harmony export */   useFetchers: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useFetchers),\n/* harmony export */   useFormAction: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useFormAction),\n/* harmony export */   useHref: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useHref),\n/* harmony export */   useInRouterContext: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useInRouterContext),\n/* harmony export */   useLinkClickHandler: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useLinkClickHandler),\n/* harmony export */   useLoaderData: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useLoaderData),\n/* harmony export */   useLocation: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useLocation),\n/* harmony export */   useMatch: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useMatch),\n/* harmony export */   useMatches: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useMatches),\n/* harmony export */   useNavigate: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useNavigate),\n/* harmony export */   useNavigation: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useNavigation),\n/* harmony export */   useNavigationType: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useNavigationType),\n/* harmony export */   useOutlet: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useOutlet),\n/* harmony export */   useOutletContext: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useOutletContext),\n/* harmony export */   useParams: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useParams),\n/* harmony export */   useResolvedPath: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useResolvedPath),\n/* harmony export */   useRevalidator: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useRevalidator),\n/* harmony export */   useRouteError: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useRouteError),\n/* harmony export */   useRouteLoaderData: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useRouteLoaderData),\n/* harmony export */   useRoutes: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useRoutes),\n/* harmony export */   useSearchParams: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useSearchParams),\n/* harmony export */   useSubmit: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useSubmit),\n/* harmony export */   useViewTransitionState: () => (/* reexport safe */ _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__.useViewTransitionState)\n/* harmony export */ });\n/* harmony import */ var _chunk_KIUJAIYX_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunk-KIUJAIYX.mjs */ \"./node_modules/react-router/dist/development/chunk-KIUJAIYX.mjs\");\n/* harmony import */ var _chunk_C37GKA54_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-C37GKA54.mjs */ \"./node_modules/react-router/dist/development/chunk-C37GKA54.mjs\");\n/**\n * react-router v7.7.1\n *\n * Copyright (c) Remix Software Inc.\n *\n * This source code is licensed under the MIT license found in the\n * LICENSE.md file in the root directory of this source tree.\n *\n * @license MIT\n */\n\"use client\";\n\n\n\n\n\n//# sourceURL=webpack://host-app-module-federation/./node_modules/react-router/dist/development/index.mjs?\n}");
